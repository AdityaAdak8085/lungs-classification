...
TFLITE_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'artifacts/training/model.tflite')
H5_MODEL_PATH = os.path.join(os.path.dirname(__file__), 'artifacts/training/model.h5')
